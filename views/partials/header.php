<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
  ...
  <ul class="col-xl-8 col-lg-8 navbar-nav d-flex m-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item nav-link-color-1" href="#">Agendar Prueba Antígeno COVID19 </a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item nav-link-color-1" href="#">¿Qué es una Prueba de Antigenos?</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item nav-link-color-1" href="3">Permiso y Marcas</a>
        </div>
      </li>
  </ul>
